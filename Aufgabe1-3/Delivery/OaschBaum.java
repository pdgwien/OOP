...
public class Test {
	...
	*/
	public static void main(String[] args)
	{
		...
		float holzwald_beginn = 100, totholz_beginn = 80, ernte_beginn = 15, verwertung_beginn = 30, verrottung_beginn = 40, gebundenesCO2_beginn = 300, holzzuwachs = 7, totholz = 10, erntemenge = 8, verwertung = 20, verrottung = 50;
		int jahre = 15;
		...
		System.out.println("");
		System.out.print("Gebundenes CO²: ");
		...
		*/
		OaschBaum ob = new OaschBaum(holzwald_beginn, totholz_beginn, ernte_beginn, verwertung_beginn, verrottung_beginn, gebundenesCO2_beginn, holzzuwachs, totholz, erntemenge, verwertung, verrottung);
		
		HashMap map = ob.getDaten(jahre);
		
		System.out.println("+------+----------+---------+-------+-----------+-----------+----------------+");
		System.out.println("| Jahr | Holzwand | Totholz | Ernte | Verwertet | Verrottet | Gebundenes CO² |");
		System.out.println("+------+----------+---------+-------+-----------+-----------+----------------+");
		for (Iterator it = map.entrySet().iterator(); it.hasNext();) {
			Entry<Integer, OaschJahr> entry = (Entry<Integer, OaschJahr>) it.next();
			
			OaschJahr oj = entry.getValue();
